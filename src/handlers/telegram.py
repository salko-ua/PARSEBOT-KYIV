...
async def repost_to_channel(query: types.CallbackQuery, state: FSMContext):
    ...
    media_messages = await query.message.bot.send_media_group(-1001610806063, media=media_group)
    await query.message.bot.edit_message_caption(
        chat_id=-1001610806063,
